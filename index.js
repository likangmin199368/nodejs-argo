...
const SUB_PATH = process.env.SUB_PATH || 'qwe';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '5293e97e-6259-4e17-ab4d-0e0bd6de563d'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || 'km4096';                        // 节点名称
